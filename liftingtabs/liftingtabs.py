...
def liftingtabs(mydb, cursor, cursorupdate):
    ...
    graph.add((URIRef("http://w3id.org/lob/concept/2833"), RDFS.label, Literal("board strap markers", lang="en")))
    ...
    graph.add((URIRef("http://w3id.org/lob/concept/1197"), RDFS.label, Literal("tawed skin", lang="en")))
    ...
    graph.add((URIRef("http://w3id.org/lob/concept/4045"), RDFS.label, Literal("nailing", lang="en")))
    graph.add((URIRef("http://stcath.overturnin"), RDF.type, CRM["E55_Type"]))
    graph.add((URIRef("http://stcath.overturnin"), RDFS.label, Literal("over turn-in attaching", lang="en")))
    graph.add((URIRef("http://stcath.underturnin"), RDF.type, CRM["E55_Type"]))
    graph.add((URIRef("http://stcath.underturnin"), RDFS.label, Literal("under turn-in attaching", lang="en")))
    ...
    graph.add((URIRef("http://stcath.brokenandsewn"), RDFS.label, Literal("broken and sewn", lang="en")))
    ...
    graph.add((URIRef("http://stcath.worn"), RDFS.label, Literal("worn", lang="en")))
    graph.add((URIRef("http://stcath.detached"), RDF.type, CRM["E55_Type"]))
    graph.add((URIRef("http://stcath.detached"), RDFS.label, Literal("detached", lang="en")))
    ...
    docgraph1.add((URIRef("http://w3id.org/lob/concept/2833"), RDFS.label, Literal("board strap markers", lang="en")))

    docgraph2.add((URIRef("http://w3id.org/lob/concept/2833"), RDF.type, CRM["E55_Type"]))
    docgraph2.add((URIRef("http://w3id.org/lob/concept/2833"), RDFS.label, Literal("board strap markers", lang="en")))
    docgraph2.add((URIRef("http://w3id.org/lob/concept/1658"), RDF.type, CRM["E55_Type"]))
    docgraph2.add((URIRef("http://w3id.org/lob/concept/1658"), RDFS.label, Literal("tanned skin", lang="en")))
    ...
    docgraph2.add((URIRef("http://stcath.underturnin"), RDFS.label, Literal("under turn-in attaching", lang="en")))
    docgraph2.add((URIRef("http://stcath.brokenoff"), RDF.type, CRM["E55_Type"]))
    docgraph2.add((URIRef("http://stcath.brokenoff"), RDFS.label, Literal("broken off", lang="en")))
