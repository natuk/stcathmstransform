...
def pagemarkers(mydb, cursor, cursorupdate):
    ...
    for row in rows:
        ...
        msuuidelement.text = row["msiduuid"]
        if row["yesnonk"] == "no":
            ...
            if bool(row["type"] == "Folded") | bool(row["type"] == "Folded and knotted"):
                pagemarkerstypeelement = etree.SubElement(pagemarkerselement, "pagemarkertype")
                pagemarkerstypeuuidelement = etree.SubElement(pagemarkerstypeelement, "pagemarkertypeuuid")
                pagemarkerstypeuuidelement.text = escape("http://w3id.org/lob/concept/2945")
                pagemarkerstypelabelelement = etree.SubElement(pagemarkerstypeelement, "pagemarkertypelabel")
            ...
            pagemarkerstypelabel2element = etree.SubElement(pagemarkerstypeelement, "pagemarkertypelabel")
